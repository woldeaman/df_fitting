...
@mpltex.acs_decorator  # making acs-style figures
def plot_test_set_err(alphas, test_err, sol_err, save=False):
...
path = home+"/Desktop/Cluster/jobs/fokkerPlanckModel/PEG_dextran/7.Batch/regularization/gel10_dex70/"
##########################################################################
...
plot_lcurve(np.array(alphas).astype(float), err_sol, err_reg, save=True)
plot_test_set_err(np.array(alphas).astype(float), test_err, err_sol, save=True)
